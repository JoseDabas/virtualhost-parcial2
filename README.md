...
`
wget https://github.com/JoseDabas/virtualhost-parcial2.git/master/basico-ubuntu.sh && chmod +x basico-ubuntu.sh && bash basico-ubuntu.sh
`

### Amazon Linux 2:
`
wget https://github.com/JoseDabas/virtualhost-parcial2.git/master/basico.sh && chmod +x basico.sh && bash basico.sh
`
